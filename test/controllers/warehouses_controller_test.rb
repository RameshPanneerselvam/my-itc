...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { branch_id: @warehouse.branch_id, warehouse_name: @warehouse.warehouse_name } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { branch_id: @warehouse.branch_id, warehouse_name: @warehouse.warehouse_name } }
